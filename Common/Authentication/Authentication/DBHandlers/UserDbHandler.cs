...
{
    class UserDbHandler : IDbHandler<IUser>
    {
        ...
        /// <returns></returns>
        public IUser Get(Dictionary<string, Object> kwargs)
        {
            return null;
        }
        ...
        /// <param name="kwargs"></param>
        /// <returns></returns>
        public IList<IUser> Filter(Dictionary<string, Object> kwargs)
        {
            return null;
        }
        ...
        /// <returns></returns>
        public IList<IUser> Update(Dictionary<string, Object> kwargs, Dictionary<string, Object> newVals)
        {
            return null;
        }
        ...
        /// <param name="kwargs"></param>
        /// <returns></returns>
        public IList<IUser> Delete(Dictionary<string, Object> kwargs)
        {
            return null;
        }
        #endregion
